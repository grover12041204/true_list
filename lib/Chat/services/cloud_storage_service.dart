...
class CloudStorageService {
  ...
  Future<String?> saveUserImageToStorage2(String _uid, String _file) async {
    try {
      Reference _ref =
          _storage.ref().child('images/users/$mongoId/profile.${_file}');
      UploadTask _task = _ref.putString(_file);
      return await _task.then(
        (_result) => _result.ref.getDownloadURL(),
      );
    } catch (e) {
